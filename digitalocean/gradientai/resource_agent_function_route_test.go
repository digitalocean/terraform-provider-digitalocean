		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDigitalOceanAgentExists("digitalocean_gradientai_function.test", &agent),
					resource.TestCheckResourceAttr("digitalocean_gradientai_function.test", "function_name", function_name),
					resource.TestCheckResourceAttr("digitalocean_gradientai_function.test", "description", "Adding a function route and this will also tell temperature"),
					resource.TestCheckResourceAttrSet("digitalocean_gradientai_function.test", "faas_name"),
					resource.TestCheckResourceAttrSet("digitalocean_gradientai_function.test", "faas_namespace"),
					resource.TestCheckResourceAttrSet("digitalocean_gradientai_function.test", "input_schema"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDigitalOceanAgentExists("digitalocean_gradientai_function.test", &agent),
					resource.TestCheckResourceAttr("digitalocean_gradientai_function.test", "function_name", function_name),
					resource.TestCheckResourceAttr("digitalocean_gradientai_function.test", "description", "Adding a function route with optional fields"),
					resource.TestCheckResourceAttrSet("digitalocean_gradientai_function.test", "faas_name"),
					resource.TestCheckResourceAttrSet("digitalocean_gradientai_function.test", "faas_namespace"),
					resource.TestCheckResourceAttrSet("digitalocean_gradientai_function.test", "input_schema"),
					resource.TestCheckResourceAttrSet("digitalocean_gradientai_function.test", "output_schema"),
				),
			},
		},
	})
