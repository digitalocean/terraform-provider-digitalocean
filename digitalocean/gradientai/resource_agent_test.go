		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDigitalOceanAgentExists("digitalocean_gradientai_agent.test", &agent),
					resource.TestCheckResourceAttr("digitalocean_gradientai_agent.test", "name", agentName),
					resource.TestCheckResourceAttr("digitalocean_gradientai_agent.test", "instruction", "You are a helpful AI assistant."),
					resource.TestCheckResourceAttrSet("digitalocean_gradientai_agent.test", "model_uuid"),
					resource.TestCheckResourceAttrSet("digitalocean_gradientai_agent.test", "project_id"),
					resource.TestCheckResourceAttrSet("digitalocean_gradientai_agent.test", "region"),
					resource.TestCheckResourceAttrSet("digitalocean_gradientai_agent.test", "created_at"),
					resource.TestCheckResourceAttrSet("digitalocean_gradientai_agent.test", "updated_at"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDigitalOceanAgentExists("digitalocean_gradientai_agent.test", &agent),
					resource.TestCheckResourceAttr("digitalocean_gradientai_agent.test", "name", agentName),
					resource.TestCheckResourceAttr("digitalocean_gradientai_agent.test", "description", "Test agent with optional fields"),
					resource.TestCheckResourceAttr("digitalocean_gradientai_agent.test", "tags.#", "2"),
					resource.TestCheckResourceAttr("digitalocean_gradientai_agent.test", "tags.0", "test"),
					resource.TestCheckResourceAttr("digitalocean_gradientai_agent.test", "tags.1", "ai"),
				),
			},
		},
	})
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDigitalOceanAgentExists("digitalocean_gradientai_agent.test", &agent),
					resource.TestCheckResourceAttr("digitalocean_gradientai_agent.test", "name", updatedName),
					resource.TestCheckResourceAttr("digitalocean_gradientai_agent.test", "instruction", "You are an updated AI assistant with new capabilities."),
					resource.TestCheckResourceAttr("digitalocean_gradientai_agent.test", "description", "Updated test agent"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDigitalOceanAgentExists("digitalocean_gradientai_agent.test", &agent),
					resource.TestCheckResourceAttr("digitalocean_gradientai_agent.test", "name", agentName),
					resource.TestCheckResourceAttr("digitalocean_gradientai_agent.test", "knowledge_base_uuid.#", "1"),
					resource.TestCheckResourceAttrSet("digitalocean_gradientai_agent.test", "knowledge_base_uuid.0"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDigitalOceanAgentExists("digitalocean_gradientai_agent.test", &agent),
					resource.TestCheckResourceAttr("digitalocean_gradientai_agent.test", "name", agentName),
					resource.TestCheckResourceAttr("digitalocean_gradientai_agent.test", "deployment.#", "1"),
					resource.TestCheckResourceAttr("digitalocean_gradientai_agent.test", "deployment.0.visibility", "private"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDigitalOceanAgentExists("digitalocean_gradientai_agent.test", &agent),
					resource.TestCheckResourceAttr("digitalocean_gradientai_agent.test", "deployment.0.visibility", "public"),
				),
			},
		},
	})
...
func TestAccDigitalOceanAgent_ImportBasic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ResourceName:      "digitalocean_gradientai_agent.test",
				ImportState:       true,
...
func testAccCheckDigitalOceanAgentDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "digitalocean_gradientai_agent" {
			continue
		}

		_, _, err := client.GradientAI.GetAgent(context.Background(), rs.Primary.ID)
		if err == nil {
...
func testAccCheckDigitalOceanAgentExists(resource string, agent *godo.Agent) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		client := acceptance.TestAccProvider.Meta().(*config.CombinedConfig).GodoClient()
		foundAgent, _, err := client.GradientAI.GetAgent(context.Background(), rs.Primary.ID)
		if err != nil {
			return err
		}
