		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("digitalocean_gradientai_openai_api_key.test", "name", keyName),
					resource.TestCheckResourceAttr("digitalocean_gradientai_openai_api_key.test", "api_key", "sk-proj-testkey"),
				),
			},
		},
	})
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("digitalocean_gradientai_openai_api_key.test", "name", updatedKeyName),
				),
			},
		},
	})
...
`, keyName)
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ResourceName:      "digitalocean_gradientai_openai_api_key.test",
				ImportState:       true,
