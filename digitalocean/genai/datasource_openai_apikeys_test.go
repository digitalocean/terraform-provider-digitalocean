...
`,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.digitalocean_genai_openai_api_keys.all", "openai_api_keys.#"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.digitalocean_genai_agents_by_openai_api_key.by_key", "agents"),
				),
			},
		},
	})
